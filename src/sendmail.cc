...
cli_option cli_options[] = {
  ...
  {  0, "odd", cli_option::flag, 0, &o_dummyi,
     "Defer delivery (ignored)", 0 },
  {  0, "odf", cli_option::flag, 0, &o_dummyi,
     "Deliver in foreground (ignored)", 0 },
  {  0, "odi", cli_option::flag, 0, &o_dummyi,
     "Deliver interactively (synchronously) (ignored)", 0 },
  {  0, "odq", cli_option::flag, 0, &o_dummyi,
     "Just queue the message (ignored)", 0 },
